...
**공동 기획 · 개발** — 기획부터 개발, App Store 심사와 출시까지 두 사람이 함께 했습니다.

| | |
| --- | --- |
| **장지웅** | [@jiwoong83](https://github.com/jiwoong83) |
| **박종윤** | [@jongyoon0130](https://github.com/jongyoon0130) |

> 초기 커밋 일부가 로컬 기본 이메일로 기록되어 GitHub 기여자 집계에 잡히지 않습니다. 실제 작업은 위 두 사람이 나눠서 했습니다.
